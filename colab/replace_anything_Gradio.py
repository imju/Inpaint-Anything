...
def get_replaced_img(img, mask0, mask1, mask2, text_prompt):
...
with gr.Blocks() as demo:
    ...
    with gr.Row().style(mobile_collapse=False, equal_height=True):
        ...
        with gr.Column(variant="panel"):
            ...
            with gr.Row():
              ...
              replaceAny = gr.Button("Replace", variant="primary").style(full_width=True, size="sm")
    ...
    with gr.Row(variant="panel"):
        with gr.Column():
            with gr.Row():
                gr.Markdown("## Background Replaced with Mask")
            with gr.Row():
                img_rm_with_mask_0 = gr.outputs.Image(
                    type="numpy", label="Background Replaced with Segmentation Mask 0").style(height="200px")
                img_rm_with_mask_1 = gr.outputs.Image(
                    type="numpy", label="Background Replaced with Segmentation Mask 1").style(height="200px")
                img_rm_with_mask_2 = gr.outputs.Image(
                    type="numpy", label="Background Replaced with Segmentation Mask 2").style(height="200px")
    ...
    clear_button_image.click(
        reset,
        [img, features, img_pointed, w, h, mask_0, mask_1, mask_2, img_with_mask_0, img_with_mask_1, img_with_mask_2, img_rm_with_mask_0, img_rm_with_mask_1, img_rm_with_mask_2, text_prompt],
        [img, features, img_pointed, w, h, mask_0, mask_1, mask_2, img_with_mask_0, img_with_mask_1, img_with_mask_2, img_rm_with_mask_0, img_rm_with_mask_1, img_rm_with_mask_2, text_prompt]
    )
